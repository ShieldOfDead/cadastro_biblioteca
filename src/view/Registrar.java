...
public class Registrar extends javax.swing.JFrame {
    ...
    public Registrar() {
        ...
        initComponents();
        readJTable();
        txtLocal.setText(r.getLocal_padrao());
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Salvar .txt"));
...
//                   r.setComputador((String) cbComputadorRegistro.getSelectedItem());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        FileWriter arq;
            ...
            try {
                reg.setLocal_padrao(txtLocal.getText());
                arq = new FileWriter(txtLocal.getText());
                PrintWriter gravarArq = new PrintWriter(arq);
            
                int mes = ((int) calendar.get(GregorianCalendar.MONTH)) + 1;
                
                gravarArq.printf("Registros do dia "+ calendar.get(GregorianCalendar.DAY_OF_MONTH) + "/" + mes + "/" + calendar.get(GregorianCalendar.YEAR) +"%n");
                gravarArq.printf("------------------------------------------------%n");
                
                for(Registro r: lista) {
                    gravarArq.printf("| %10s | %15s | %5s | %5s |%n", r.getNome(), r.getMatricula(), r.getHorario(), r.getComputador());
                    gravarArq.printf("------------------------------------------------%n");
                }
                
                JOptionPane.showMessageDialog(null, "Arquivo salvo com sucesso em: " + txtLocal.getText());
                arq.close();
            
            } catch (IOException ex) {
               Logger.getLogger(Registrar.class.getName()).log(Level.SEVERE, null, ex);
               JOptionPane.showMessageDialog(null, "Endereço desconhecido ou incorreto");
            }
            } else {
                JOptionPane.showMessageDialog(null, "Local vazio");
            }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (res == JFileChooser.APPROVE_OPTION) {
            ...
            r.setLocal_padrao(diretorio.getPath());
            txtLocal.setText(r.getLocal_padrao()+"\\dados.txt");
